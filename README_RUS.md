...
Реализация улучшенной версии калькулятора SmartCalc v2.0.
...
3. [Реализация функций](#реализация-функций)
   - [Часть 1: Основной калькулятор](#часть-1-основной-калькулятор)
   - [Часть 2: Кредитный калькулятор](#часть-2-кредитный-калькулятор)
   - [Часть 3: Депозитный калькулятор](#часть-3-депозитный-калькулятор)

## Введение

SmartCalc v2.0 — это проект, в котором вы будете реализовывать различные функции калькулятора, начиная от простых арифметических операций и заканчивая расчетами по кредитам и вкладам.

## Общая информация

Калькулятор предназначен для выполнения базовых и расширенных математических операций, предоставляя пользователю гибкие инструменты для финансового планирования.

### Основные функции

- Арифметические операции (сложение, вычитание, умножение, деление)
- Функции для расчета процентов, косинусов, синусов и других математических действий
- Поддержка комплексных выражений и скобок

## Реализация функций

### Часть 1: Основной калькулятор

Реализация основного функционала калькулятора, включая:
- Все стандартные математические операции
- Поддержка унарных операций
- Расширенные математические функции (логарифмы, тригонометрические функции)

### Часть 2: Кредитный калькулятор

Разработка специализированного калькулятора для расчета кредитов, позволяющего:
- Вычислять ежемесячные платежи
- Определять общую переплату по кредиту
- Рассчитывать общую сумму выплат

### Часть 3: Депозитный калькулятор

Реализация функционала для расчета доходности вкладов, включая:
- Вычисление начисленных процентов
- Расчет налогов на доходы от вкладов
- Управление пополнениями и частичными снятиями средств
